...
sl_folder ${SD22_DIR}/forge/models GFPGAN ${BASE_DIR}/models gfpgan
sl_folder ${SD22_DIR}/forge/models LDSR ${BASE_DIR}/models/upscale LDSR
sl_folder ${SD22_DIR}/forge/models RealESRGAN ${BASE_DIR}/models/upscale ESRGAN
sl_folder ${SD22_DIR}/forge/models ESRGAN ${BASE_DIR}/models/upscale ESRGAN
...
sl_folder ${SD22_DIR}/forge/models insightface ${BASE_DIR}/models/clip insightface
